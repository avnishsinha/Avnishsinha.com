...
export const projects: Project[] = [
  ...
  },
  {
    ...
    solution: 'Created a clean, professional site with strong SEO foundation, client testimonials, and WhatsApp integration for instant consultations.',
    results: [
  ...
  },
  {
    ...
    description: 'Menu showcase and reservation system. WhatsApp ordering built-in.',
    tech: ['Next.js', 'WhatsApp API', 'Google Maps'],
    year: '2024',
    problem: 'Restaurant was losing bookings to competitors. Phone-only reservations were limiting growth.',
    solution: 'Built a visual menu showcase with instant WhatsApp reservation system. Integrated Google Maps and opening hours.',
    results: [
      'Reservations increased 60%',
      'WhatsApp orders now 40% of business',
